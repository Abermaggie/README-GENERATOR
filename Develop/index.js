...
// function gitBadge() {
//   if(answers.licenseOptions !== 'none') {
//     return `![GitHub license](https://img.shields.io/badge/license-${licenseOptions}-blue.svg)`;
//   }
// }
// let applyBadge = gitBadge();
...
inquirer
  ...
  .then((answers) => {
    ...
    console.log(answers.licenseOptions)
